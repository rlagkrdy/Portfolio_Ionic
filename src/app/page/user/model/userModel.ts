...
export class UserListModel {
    private usrListObj: Array<object> = [
        {
            id: 'USR_CREATE',
            name: '가입일시',
            type: 'date',
    ...
    private usrDeleteListObj: Array<object> = [
        {
            id: 'USR_DELETE_DATE',
            name: '탈퇴일시',
            type: 'date',
    ...
    private usrListDefs: (ColDef | ColGroupDef)[] = [
    ...
    private usrDeleteListDefs: (ColDef | ColGroupDef)[] = [
        { headerName: '회원명', field: 'USR_NAME', width: 100 },
        { headerName: '아이디', field: 'USR_ID', width: 100 },
        { headerName: '연락처', field: 'USR_TEL', width: 150 },
        { headerName: 'SNS여부', field: 'USR_SNS_WAY', width: 100 },
    ...
    getSearchObj(_type: string): Array<object> {
        return this[_type + 'Obj'];
    }

    getColumDef(_type: string): (ColDef | ColGroupDef)[] {
        return this[_type + 'Defs'];
    }
}
